## Teste de composicao: quick_time_alternative + screen_shake
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: quick_time_alternative
...
func test_coexistencia() -> void:
	var res_a := load("res://behaviors/quick_time_alternative/quick_time_alternative.tscn")
	assert_object(res_a).is_not_null().override_failure_message("Falha ao carregar res://behaviors/quick_time_alternative/quick_time_alternative.tscn")
	...
	assert_bool(is_instance_valid(_behavior_a)).override_failure_message("quick_time_alternative foi liberado durante o teste")
