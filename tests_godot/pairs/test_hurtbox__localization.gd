## Teste de composicao: hurtbox + localization
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: hurtbox
## @behavior_b: localization
...
func test_coexistencia() -> void:
	...
	var res_b := load("res://behaviors/localization/localization.tscn")
	assert_object(res_b).is_not_null().override_failure_message("Falha ao carregar res://behaviors/localization/localization.tscn")
	...
	assert_bool(is_instance_valid(_behavior_b)).override_failure_message("localization foi liberado durante o teste")
	...
	assert_bool(_behavior_b.has_signal("locale_changed")).override_failure_message("Sinal 'locale_changed' nao encontrado em localization")
