## Teste de composicao: noise_generator + particle_impact
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: noise_generator
...
func test_coexistencia() -> void:
	var res_a := load("res://behaviors/noise_generator/noise_generator.tscn")
	assert_object(res_a).is_not_null().override_failure_message("Falha ao carregar res://behaviors/noise_generator/noise_generator.tscn")
	...
	assert_bool(is_instance_valid(_behavior_a)).override_failure_message("noise_generator foi liberado durante o teste")
