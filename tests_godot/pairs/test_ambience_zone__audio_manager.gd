## Teste de composicao: ambience_zone + audio_manager
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: ambience_zone
## @behavior_b: audio_manager
...
func test_coexistencia() -> void:
	...
	var res_b := load("res://behaviors/audio_manager/audio_manager.tscn")
	assert_object(res_b).is_not_null().override_failure_message("Falha ao carregar res://behaviors/audio_manager/audio_manager.tscn")
	...
	assert_bool(is_instance_valid(_behavior_b)).override_failure_message("audio_manager foi liberado durante o teste")
