## Teste de composicao: screen_shake_toggle + tween_player
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: screen_shake_toggle
...
func test_coexistencia() -> void:
	var res_a := load("res://behaviors/screen_shake_toggle/screen_shake_toggle.tscn")
	assert_object(res_a).is_not_null().override_failure_message("Falha ao carregar res://behaviors/screen_shake_toggle/screen_shake_toggle.tscn")
	...
	assert_bool(is_instance_valid(_behavior_a)).override_failure_message("screen_shake_toggle foi liberado durante o teste")
