## Teste de composicao: l_system + particle_impact
##
...
func test_coexistencia() -> void:
	var res_a := load("res://behaviors/l_system/l_system.tscn")
	assert_object(res_a).is_not_null().override_failure_message("Falha ao carregar res://behaviors/l_system/l_system.tscn")
	...
	assert_bool(is_instance_valid(_behavior_a)).override_failure_message("l_system foi liberado durante o teste")
