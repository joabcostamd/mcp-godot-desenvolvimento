## Teste de composicao: particle_impact + server_sprite
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: particle_impact
## @behavior_b: server_sprite
...
func test_coexistencia() -> void:
	...
	var res_b := load("res://behaviors/server_sprite/server_sprite.tscn")
	assert_object(res_b).is_not_null().override_failure_message("Falha ao carregar res://behaviors/server_sprite/server_sprite.tscn")
	...
	assert_bool(is_instance_valid(_behavior_b)).override_failure_message("server_sprite foi liberado durante o teste")
