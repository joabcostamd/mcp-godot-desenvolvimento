## Teste de composicao: hitbox + hot_reload
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: hitbox
## @behavior_b: hot_reload
...
func test_coexistencia() -> void:
	...
	var res_b := load("res://behaviors/hot_reload/hot_reload.tscn")
	assert_object(res_b).is_not_null().override_failure_message("Falha ao carregar res://behaviors/hot_reload/hot_reload.tscn")
	...
	assert_bool(is_instance_valid(_behavior_b)).override_failure_message("hot_reload foi liberado durante o teste")
