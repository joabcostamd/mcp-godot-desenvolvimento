## Teste de composicao: particle_impact + player_vehicle
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: particle_impact
## @behavior_b: player_vehicle
...
func test_coexistencia() -> void:
	...
	var res_b := load("res://behaviors/player_vehicle/player_vehicle.tscn")
	assert_object(res_b).is_not_null().override_failure_message("Falha ao carregar res://behaviors/player_vehicle/player_vehicle.tscn")
	...
	assert_bool(is_instance_valid(_behavior_b)).override_failure_message("player_vehicle foi liberado durante o teste")
