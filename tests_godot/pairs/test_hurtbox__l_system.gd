## Teste de composicao: hurtbox + l_system
##
...
func test_coexistencia() -> void:
	...
	var res_b := load("res://behaviors/l_system/l_system.tscn")
	assert_object(res_b).is_not_null().override_failure_message("Falha ao carregar res://behaviors/l_system/l_system.tscn")
	...
	assert_bool(is_instance_valid(_behavior_b)).override_failure_message("l_system foi liberado durante o teste")
