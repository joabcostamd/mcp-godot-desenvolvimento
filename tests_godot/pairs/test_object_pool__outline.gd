## Teste de composicao: object_pool + outline
##
...
func test_coexistencia() -> void:
	...
	var res_b := load("res://behaviors/outline/outline.tscn")
	assert_object(res_b).is_not_null().override_failure_message("Falha ao carregar res://behaviors/outline/outline.tscn")
	...
	assert_bool(is_instance_valid(_behavior_b)).override_failure_message("outline foi liberado durante o teste")
