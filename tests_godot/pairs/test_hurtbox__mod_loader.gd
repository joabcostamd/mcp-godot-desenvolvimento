## Teste de composicao: hurtbox + mod_loader
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: hurtbox
## @behavior_b: mod_loader
...
func test_coexistencia() -> void:
	...
	var res_b := load("res://behaviors/mod_loader/mod_loader.tscn")
	assert_object(res_b).is_not_null().override_failure_message("Falha ao carregar res://behaviors/mod_loader/mod_loader.tscn")
	...
	assert_bool(is_instance_valid(_behavior_b)).override_failure_message("mod_loader foi liberado durante o teste")
