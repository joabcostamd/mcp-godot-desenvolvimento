## Teste de composicao: outline + particle_impact
##
...
func test_coexistencia() -> void:
	var res_a := load("res://behaviors/outline/outline.tscn")
	assert_object(res_a).is_not_null().override_failure_message("Falha ao carregar res://behaviors/outline/outline.tscn")
	...
	assert_bool(is_instance_valid(_behavior_a)).override_failure_message("outline foi liberado durante o teste")
