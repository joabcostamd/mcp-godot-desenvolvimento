## Teste de composicao: particle_impact + stereo_to_mono
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: particle_impact
## @behavior_b: stereo_to_mono
...
func test_coexistencia() -> void:
	...
	var res_b := load("res://behaviors/stereo_to_mono/stereo_to_mono.tscn")
	assert_object(res_b).is_not_null().override_failure_message("Falha ao carregar res://behaviors/stereo_to_mono/stereo_to_mono.tscn")
	...
	assert_bool(is_instance_valid(_behavior_b)).override_failure_message("stereo_to_mono foi liberado durante o teste")
