## Teste de composicao: shop + state_machine
##
...
func test_coexistencia() -> void:
	var res_a := load("res://behaviors/shop/shop.tscn")
	assert_object(res_a).is_not_null().override_failure_message("Falha ao carregar res://behaviors/shop/shop.tscn")
	...
	assert_bool(is_instance_valid(_behavior_a)).override_failure_message("shop foi liberado durante o teste")
	...
	assert_bool(_behavior_a.has_signal("item_bought")).override_failure_message("Sinal 'item_bought' nao encontrado em shop")

	# Sinal 'item_sold': verifica conectividade
	assert_bool(_behavior_a.has_signal("item_sold")).override_failure_message("Sinal 'item_sold' nao encontrado em shop")

	# Sinal 'insufficient_funds': verifica conectividade
	assert_bool(_behavior_a.has_signal("insufficient_funds")).override_failure_message("Sinal 'insufficient_funds' nao encontrado em shop")
