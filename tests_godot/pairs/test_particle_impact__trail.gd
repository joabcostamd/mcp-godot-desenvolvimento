## Teste de composicao: particle_impact + trail
##
...
func test_coexistencia() -> void:
	...
	var res_b := load("res://behaviors/trail/trail.tscn")
	assert_object(res_b).is_not_null().override_failure_message("Falha ao carregar res://behaviors/trail/trail.tscn")
	...
	assert_bool(is_instance_valid(_behavior_b)).override_failure_message("trail foi liberado durante o teste")
