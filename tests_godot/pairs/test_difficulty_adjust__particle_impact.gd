## Teste de composicao: difficulty_adjust + particle_impact
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: difficulty_adjust
...
func test_coexistencia() -> void:
	var res_a := load("res://behaviors/difficulty_adjust/difficulty_adjust.tscn")
	assert_object(res_a).is_not_null().override_failure_message("Falha ao carregar res://behaviors/difficulty_adjust/difficulty_adjust.tscn")
	...
	assert_bool(is_instance_valid(_behavior_a)).override_failure_message("difficulty_adjust foi liberado durante o teste")
