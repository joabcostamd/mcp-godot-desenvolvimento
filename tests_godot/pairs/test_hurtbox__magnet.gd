## Teste de composicao: hurtbox + magnet
##
...
func test_coexistencia() -> void:
	...
	var res_b := load("res://behaviors/magnet/magnet.tscn")
	assert_object(res_b).is_not_null().override_failure_message("Falha ao carregar res://behaviors/magnet/magnet.tscn")
	...
	assert_bool(is_instance_valid(_behavior_b)).override_failure_message("magnet foi liberado durante o teste")
	...
	assert_bool(_behavior_b.has_signal("attracted")).override_failure_message("Sinal 'attracted' nao encontrado em magnet")
