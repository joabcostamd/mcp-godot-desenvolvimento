## Teste de composicao: plugin_creator + tween_player
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: plugin_creator
...
func test_coexistencia() -> void:
	var res_a := load("res://behaviors/plugin_creator/plugin_creator.tscn")
	assert_object(res_a).is_not_null().override_failure_message("Falha ao carregar res://behaviors/plugin_creator/plugin_creator.tscn")
	...
	assert_bool(is_instance_valid(_behavior_a)).override_failure_message("plugin_creator foi liberado durante o teste")
