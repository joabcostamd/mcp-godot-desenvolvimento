## Teste de composicao: lava_surface + particle_impact
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: lava_surface
...
func test_coexistencia() -> void:
	var res_a := load("res://behaviors/lava_surface/lava_surface.tscn")
	assert_object(res_a).is_not_null().override_failure_message("Falha ao carregar res://behaviors/lava_surface/lava_surface.tscn")
	...
	assert_bool(is_instance_valid(_behavior_a)).override_failure_message("lava_surface foi liberado durante o teste")
