## Teste de composicao: enemy_chase + flocking
##
...
func test_coexistencia() -> void:
	...
	var res_b := load("res://behaviors/flocking/flocking.tscn")
	assert_object(res_b).is_not_null().override_failure_message("Falha ao carregar res://behaviors/flocking/flocking.tscn")
	...
	assert_bool(is_instance_valid(_behavior_b)).override_failure_message("flocking foi liberado durante o teste")
