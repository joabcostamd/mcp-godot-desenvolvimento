## Teste de composicao: particle_impact + wind_zone
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: particle_impact
## @behavior_b: wind_zone
...
func test_coexistencia() -> void:
	...
	var res_b := load("res://behaviors/wind_zone/wind_zone.tscn")
	assert_object(res_b).is_not_null().override_failure_message("Falha ao carregar res://behaviors/wind_zone/wind_zone.tscn")
	...
	assert_bool(is_instance_valid(_behavior_b)).override_failure_message("wind_zone foi liberado durante o teste")
