## Teste de composicao: particle_impact + quick_time_alternative
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: particle_impact
## @behavior_b: quick_time_alternative
...
func test_coexistencia() -> void:
	...
	var res_b := load("res://behaviors/quick_time_alternative/quick_time_alternative.tscn")
	assert_object(res_b).is_not_null().override_failure_message("Falha ao carregar res://behaviors/quick_time_alternative/quick_time_alternative.tscn")
	...
	assert_bool(is_instance_valid(_behavior_b)).override_failure_message("quick_time_alternative foi liberado durante o teste")
