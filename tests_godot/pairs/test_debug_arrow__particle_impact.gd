## Teste de composicao: debug_arrow + particle_impact
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: debug_arrow
...
func test_coexistencia() -> void:
	var res_a := load("res://behaviors/debug_arrow/debug_arrow.tscn")
	assert_object(res_a).is_not_null().override_failure_message("Falha ao carregar res://behaviors/debug_arrow/debug_arrow.tscn")
	...
	assert_bool(is_instance_valid(_behavior_a)).override_failure_message("debug_arrow foi liberado durante o teste")
