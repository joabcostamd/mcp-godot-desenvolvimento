## Teste de composicao: hurtbox + infinite_world
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: hurtbox
## @behavior_b: infinite_world
...
func test_coexistencia() -> void:
	...
	var res_b := load("res://behaviors/infinite_world/infinite_world.tscn")
	assert_object(res_b).is_not_null().override_failure_message("Falha ao carregar res://behaviors/infinite_world/infinite_world.tscn")
	...
	assert_bool(is_instance_valid(_behavior_b)).override_failure_message("infinite_world foi liberado durante o teste")
