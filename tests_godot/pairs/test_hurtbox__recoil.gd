## Teste de composicao: hurtbox + recoil
##
...
func test_coexistencia() -> void:
	...
	var res_b := load("res://behaviors/recoil/recoil.tscn")
	assert_object(res_b).is_not_null().override_failure_message("Falha ao carregar res://behaviors/recoil/recoil.tscn")
	...
	assert_bool(is_instance_valid(_behavior_b)).override_failure_message("recoil foi liberado durante o teste")
