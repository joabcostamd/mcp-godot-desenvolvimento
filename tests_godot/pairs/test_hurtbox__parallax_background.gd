## Teste de composicao: hurtbox + parallax_background
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: hurtbox
## @behavior_b: parallax_background
...
func test_coexistencia() -> void:
	...
	var res_b := load("res://behaviors/parallax_background/parallax_background.tscn")
	assert_object(res_b).is_not_null().override_failure_message("Falha ao carregar res://behaviors/parallax_background/parallax_background.tscn")
	...
	assert_bool(is_instance_valid(_behavior_b)).override_failure_message("parallax_background foi liberado durante o teste")
