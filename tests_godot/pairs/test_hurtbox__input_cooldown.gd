## Teste de composicao: hurtbox + input_cooldown
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: hurtbox
## @behavior_b: input_cooldown
...
func test_coexistencia() -> void:
	...
	var res_b := load("res://behaviors/input_cooldown/input_cooldown.tscn")
	assert_object(res_b).is_not_null().override_failure_message("Falha ao carregar res://behaviors/input_cooldown/input_cooldown.tscn")
	...
	assert_bool(is_instance_valid(_behavior_b)).override_failure_message("input_cooldown foi liberado durante o teste")
