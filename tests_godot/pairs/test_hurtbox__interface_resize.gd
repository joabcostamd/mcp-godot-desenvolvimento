## Teste de composicao: hurtbox + interface_resize
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: hurtbox
## @behavior_b: interface_resize
...
func test_coexistencia() -> void:
	...
	var res_b := load("res://behaviors/interface_resize/interface_resize.tscn")
	assert_object(res_b).is_not_null().override_failure_message("Falha ao carregar res://behaviors/interface_resize/interface_resize.tscn")
	...
	assert_bool(is_instance_valid(_behavior_b)).override_failure_message("interface_resize foi liberado durante o teste")
