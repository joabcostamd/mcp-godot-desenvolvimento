## Teste de composicao: blend_space_1d + particle_impact
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: blend_space_1d
...
func test_coexistencia() -> void:
	var res_a := load("res://behaviors/blend_space_1d/blend_space_1d.tscn")
	assert_object(res_a).is_not_null().override_failure_message("Falha ao carregar res://behaviors/blend_space_1d/blend_space_1d.tscn")
	...
	assert_bool(is_instance_valid(_behavior_a)).override_failure_message("blend_space_1d foi liberado durante o teste")
