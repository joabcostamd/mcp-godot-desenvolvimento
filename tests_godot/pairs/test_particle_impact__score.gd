## Teste de composicao: particle_impact + score
##
...
func test_coexistencia() -> void:
	...
	var res_b := load("res://behaviors/score/score.tscn")
	assert_object(res_b).is_not_null().override_failure_message("Falha ao carregar res://behaviors/score/score.tscn")
	...
	assert_bool(is_instance_valid(_behavior_b)).override_failure_message("score foi liberado durante o teste")
	...
	assert_bool(_behavior_b.has_signal("score_changed")).override_failure_message("Sinal 'score_changed' nao encontrado em score")

	# Sinal 'new_high_score': verifica conectividade
	assert_bool(_behavior_b.has_signal("new_high_score")).override_failure_message("Sinal 'new_high_score' nao encontrado em score")

	# Sinal 'combo_reached': verifica conectividade
	assert_bool(_behavior_b.has_signal("combo_reached")).override_failure_message("Sinal 'combo_reached' nao encontrado em score")
