## Teste de composicao: skeleton_ik + tween_player
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: skeleton_ik
...
func test_coexistencia() -> void:
	var res_a := load("res://behaviors/skeleton_ik/skeleton_ik.tscn")
	assert_object(res_a).is_not_null().override_failure_message("Falha ao carregar res://behaviors/skeleton_ik/skeleton_ik.tscn")
	...
	assert_bool(is_instance_valid(_behavior_a)).override_failure_message("skeleton_ik foi liberado durante o teste")
