## Teste de composicao: logger + particle_impact
##
...
func test_coexistencia() -> void:
	var res_a := load("res://behaviors/logger/logger.tscn")
	assert_object(res_a).is_not_null().override_failure_message("Falha ao carregar res://behaviors/logger/logger.tscn")
	...
	assert_bool(is_instance_valid(_behavior_a)).override_failure_message("logger foi liberado durante o teste")
