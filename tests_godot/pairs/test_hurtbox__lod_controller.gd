## Teste de composicao: hurtbox + lod_controller
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: hurtbox
## @behavior_b: lod_controller
...
func test_coexistencia() -> void:
	...
	var res_b := load("res://behaviors/lod_controller/lod_controller.tscn")
	assert_object(res_b).is_not_null().override_failure_message("Falha ao carregar res://behaviors/lod_controller/lod_controller.tscn")
	...
	assert_bool(is_instance_valid(_behavior_b)).override_failure_message("lod_controller foi liberado durante o teste")
