## Teste de composicao: knockback + state_machine
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: knockback
...
func test_coexistencia() -> void:
	var res_a := load("res://behaviors/knockback/knockback.tscn")
	assert_object(res_a).is_not_null().override_failure_message("Falha ao carregar res://behaviors/knockback/knockback.tscn")
	...
	assert_bool(is_instance_valid(_behavior_a)).override_failure_message("knockback foi liberado durante o teste")
	...
	assert_bool(_behavior_a.has_signal("knocked_back")).override_failure_message("Sinal 'knocked_back' nao encontrado em knockback")
