## Teste de composicao: particle_impact + spread
##
...
func test_coexistencia() -> void:
	...
	var res_b := load("res://behaviors/spread/spread.tscn")
	assert_object(res_b).is_not_null().override_failure_message("Falha ao carregar res://behaviors/spread/spread.tscn")
	...
	assert_bool(is_instance_valid(_behavior_b)).override_failure_message("spread foi liberado durante o teste")
