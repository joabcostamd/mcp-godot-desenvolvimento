## Teste de composicao: outline_shader + particle_impact
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: outline_shader
...
func test_coexistencia() -> void:
	var res_a := load("res://behaviors/outline_shader/outline_shader.tscn")
	assert_object(res_a).is_not_null().override_failure_message("Falha ao carregar res://behaviors/outline_shader/outline_shader.tscn")
	...
	assert_bool(is_instance_valid(_behavior_a)).override_failure_message("outline_shader foi liberado durante o teste")
