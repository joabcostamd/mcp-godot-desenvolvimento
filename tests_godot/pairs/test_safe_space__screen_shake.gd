## Teste de composicao: safe_space + screen_shake
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: safe_space
...
func test_coexistencia() -> void:
	var res_a := load("res://behaviors/safe_space/safe_space.tscn")
	assert_object(res_a).is_not_null().override_failure_message("Falha ao carregar res://behaviors/safe_space/safe_space.tscn")
	...
	assert_bool(is_instance_valid(_behavior_a)).override_failure_message("safe_space foi liberado durante o teste")
