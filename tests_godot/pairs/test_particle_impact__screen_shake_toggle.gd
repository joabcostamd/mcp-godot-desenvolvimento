## Teste de composicao: particle_impact + screen_shake_toggle
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: particle_impact
## @behavior_b: screen_shake_toggle
...
func test_coexistencia() -> void:
	...
	var res_b := load("res://behaviors/screen_shake_toggle/screen_shake_toggle.tscn")
	assert_object(res_b).is_not_null().override_failure_message("Falha ao carregar res://behaviors/screen_shake_toggle/screen_shake_toggle.tscn")
	...
	assert_bool(is_instance_valid(_behavior_b)).override_failure_message("screen_shake_toggle foi liberado durante o teste")
