## Teste de composicao: particle_impact + plugin_creator
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: particle_impact
## @behavior_b: plugin_creator
...
func test_coexistencia() -> void:
	...
	var res_b := load("res://behaviors/plugin_creator/plugin_creator.tscn")
	assert_object(res_b).is_not_null().override_failure_message("Falha ao carregar res://behaviors/plugin_creator/plugin_creator.tscn")
	...
	assert_bool(is_instance_valid(_behavior_b)).override_failure_message("plugin_creator foi liberado durante o teste")
