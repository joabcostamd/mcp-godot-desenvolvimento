## Teste de composicao: auto_aim + particle_impact
##
...
func test_coexistencia() -> void:
	var res_a := load("res://behaviors/auto_aim/auto_aim.tscn")
	assert_object(res_a).is_not_null().override_failure_message("Falha ao carregar res://behaviors/auto_aim/auto_aim.tscn")
	...
	assert_bool(is_instance_valid(_behavior_a)).override_failure_message("auto_aim foi liberado durante o teste")
