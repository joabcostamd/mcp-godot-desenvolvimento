## Teste de composicao: game_speed_control + particle_impact
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: game_speed_control
...
func test_coexistencia() -> void:
	var res_a := load("res://behaviors/game_speed_control/game_speed_control.tscn")
	assert_object(res_a).is_not_null().override_failure_message("Falha ao carregar res://behaviors/game_speed_control/game_speed_control.tscn")
	...
	assert_bool(is_instance_valid(_behavior_a)).override_failure_message("game_speed_control foi liberado durante o teste")
