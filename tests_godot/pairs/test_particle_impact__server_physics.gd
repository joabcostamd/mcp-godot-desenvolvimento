## Teste de composicao: particle_impact + server_physics
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: particle_impact
## @behavior_b: server_physics
...
func test_coexistencia() -> void:
	...
	var res_b := load("res://behaviors/server_physics/server_physics.tscn")
	assert_object(res_b).is_not_null().override_failure_message("Falha ao carregar res://behaviors/server_physics/server_physics.tscn")
	...
	assert_bool(is_instance_valid(_behavior_b)).override_failure_message("server_physics foi liberado durante o teste")
