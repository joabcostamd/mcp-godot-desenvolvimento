## Teste de composicao: random_loot + state_machine
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: random_loot
...
func test_coexistencia() -> void:
	var res_a := load("res://behaviors/random_loot/random_loot.tscn")
	assert_object(res_a).is_not_null().override_failure_message("Falha ao carregar res://behaviors/random_loot/random_loot.tscn")
	...
	assert_bool(is_instance_valid(_behavior_a)).override_failure_message("random_loot foi liberado durante o teste")
	...
	assert_bool(_behavior_a.has_signal("loot_dropped")).override_failure_message("Sinal 'loot_dropped' nao encontrado em random_loot")

	# Sinal 'rare_drop': verifica conectividade
	assert_bool(_behavior_a.has_signal("rare_drop")).override_failure_message("Sinal 'rare_drop' nao encontrado em random_loot")
