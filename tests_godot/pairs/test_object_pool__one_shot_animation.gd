## Teste de composicao: object_pool + one_shot_animation
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: object_pool
## @behavior_b: one_shot_animation
...
func test_coexistencia() -> void:
	...
	var res_b := load("res://behaviors/one_shot_animation/one_shot_animation.tscn")
	assert_object(res_b).is_not_null().override_failure_message("Falha ao carregar res://behaviors/one_shot_animation/one_shot_animation.tscn")
	...
	assert_bool(is_instance_valid(_behavior_b)).override_failure_message("one_shot_animation foi liberado durante o teste")
