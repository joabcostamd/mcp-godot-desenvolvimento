## Teste de composicao: hurtbox + logger
##
...
func test_coexistencia() -> void:
	...
	var res_b := load("res://behaviors/logger/logger.tscn")
	assert_object(res_b).is_not_null().override_failure_message("Falha ao carregar res://behaviors/logger/logger.tscn")
	...
	assert_bool(is_instance_valid(_behavior_b)).override_failure_message("logger foi liberado durante o teste")
