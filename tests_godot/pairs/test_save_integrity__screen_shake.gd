## Teste de composicao: save_integrity + screen_shake
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: save_integrity
...
func test_coexistencia() -> void:
	var res_a := load("res://behaviors/save_integrity/save_integrity.tscn")
	assert_object(res_a).is_not_null().override_failure_message("Falha ao carregar res://behaviors/save_integrity/save_integrity.tscn")
	...
	assert_bool(is_instance_valid(_behavior_a)).override_failure_message("save_integrity foi liberado durante o teste")
