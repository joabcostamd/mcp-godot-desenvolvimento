## Teste de composicao: root_motion_controller + screen_shake
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: root_motion_controller
...
func test_coexistencia() -> void:
	var res_a := load("res://behaviors/root_motion_controller/root_motion_controller.tscn")
	assert_object(res_a).is_not_null().override_failure_message("Falha ao carregar res://behaviors/root_motion_controller/root_motion_controller.tscn")
	...
	assert_bool(is_instance_valid(_behavior_a)).override_failure_message("root_motion_controller foi liberado durante o teste")
