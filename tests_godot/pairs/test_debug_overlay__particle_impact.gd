## Teste de composicao: debug_overlay + particle_impact
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: debug_overlay
...
func test_coexistencia() -> void:
	var res_a := load("res://behaviors/debug_overlay/debug_overlay.tscn")
	assert_object(res_a).is_not_null().override_failure_message("Falha ao carregar res://behaviors/debug_overlay/debug_overlay.tscn")
	...
	assert_bool(is_instance_valid(_behavior_a)).override_failure_message("debug_overlay foi liberado durante o teste")
