## Teste de composicao: patch_system + screen_shake
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: patch_system
...
func test_coexistencia() -> void:
	var res_a := load("res://behaviors/patch_system/patch_system.tscn")
	assert_object(res_a).is_not_null().override_failure_message("Falha ao carregar res://behaviors/patch_system/patch_system.tscn")
	...
	assert_bool(is_instance_valid(_behavior_a)).override_failure_message("patch_system foi liberado durante o teste")
