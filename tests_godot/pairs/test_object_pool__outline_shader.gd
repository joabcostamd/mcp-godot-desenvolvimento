## Teste de composicao: object_pool + outline_shader
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: object_pool
## @behavior_b: outline_shader
...
func test_coexistencia() -> void:
	...
	var res_b := load("res://behaviors/outline_shader/outline_shader.tscn")
	assert_object(res_b).is_not_null().override_failure_message("Falha ao carregar res://behaviors/outline_shader/outline_shader.tscn")
	...
	assert_bool(is_instance_valid(_behavior_b)).override_failure_message("outline_shader foi liberado durante o teste")
