## Teste de composicao: spread + state_machine
##
...
func test_coexistencia() -> void:
	var res_a := load("res://behaviors/spread/spread.tscn")
	assert_object(res_a).is_not_null().override_failure_message("Falha ao carregar res://behaviors/spread/spread.tscn")
	...
	assert_bool(is_instance_valid(_behavior_a)).override_failure_message("spread foi liberado durante o teste")
