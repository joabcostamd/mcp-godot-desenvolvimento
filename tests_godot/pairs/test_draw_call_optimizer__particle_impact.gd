## Teste de composicao: draw_call_optimizer + particle_impact
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: draw_call_optimizer
...
func test_coexistencia() -> void:
	var res_a := load("res://behaviors/draw_call_optimizer/draw_call_optimizer.tscn")
	assert_object(res_a).is_not_null().override_failure_message("Falha ao carregar res://behaviors/draw_call_optimizer/draw_call_optimizer.tscn")
	...
	assert_bool(is_instance_valid(_behavior_a)).override_failure_message("draw_call_optimizer foi liberado durante o teste")
