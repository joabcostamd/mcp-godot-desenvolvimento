## Teste de composicao: tooltip + tween_player
##
...
func test_coexistencia() -> void:
	var res_a := load("res://behaviors/tooltip/tooltip.tscn")
	assert_object(res_a).is_not_null().override_failure_message("Falha ao carregar res://behaviors/tooltip/tooltip.tscn")
	...
	assert_bool(is_instance_valid(_behavior_a)).override_failure_message("tooltip foi liberado durante o teste")
	...
	assert_bool(_behavior_a.has_signal("tooltip_shown")).override_failure_message("Sinal 'tooltip_shown' nao encontrado em tooltip")

	# Sinal 'tooltip_hidden': verifica conectividade
	assert_bool(_behavior_a.has_signal("tooltip_hidden")).override_failure_message("Sinal 'tooltip_hidden' nao encontrado em tooltip")
