## Teste de composicao: button_mash_protection + particle_impact
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: button_mash_protection
...
func test_coexistencia() -> void:
	var res_a := load("res://behaviors/button_mash_protection/button_mash_protection.tscn")
	assert_object(res_a).is_not_null().override_failure_message("Falha ao carregar res://behaviors/button_mash_protection/button_mash_protection.tscn")
	...
	assert_bool(is_instance_valid(_behavior_a)).override_failure_message("button_mash_protection foi liberado durante o teste")
