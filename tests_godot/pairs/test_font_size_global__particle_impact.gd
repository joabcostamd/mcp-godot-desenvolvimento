## Teste de composicao: font_size_global + particle_impact
##
## Gerado automaticamente por scripts/gerar_testes_pares.py (sota_1.7).
## Verifica que os dois behaviors coexistem sem erro e seus sinais ainda emitem.
##
## @behavior_a: font_size_global
...
func test_coexistencia() -> void:
	var res_a := load("res://behaviors/font_size_global/font_size_global.tscn")
	assert_object(res_a).is_not_null().override_failure_message("Falha ao carregar res://behaviors/font_size_global/font_size_global.tscn")
	...
	assert_bool(is_instance_valid(_behavior_a)).override_failure_message("font_size_global foi liberado durante o teste")
