...
func test_defaults() -> void: var o:=AnimationCurveTable.new(); o.queue_free()

func test_edge_case_multiple_instances() -> void:
	var a := AnimationCurveTable.new()
	var b := AnimationCurveTable.new()
